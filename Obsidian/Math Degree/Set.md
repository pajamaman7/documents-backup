A set is a collection of objects, or elements. They can be finite, infinite, but they are [[Well-Defined]], meaning every element is unique. For example, the set of all numbers from 1 to 5 is:
$$S=\{1,2,3,4,5\}$$
